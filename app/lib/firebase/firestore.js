 ...
 *   let error = new ErrorFactory<Err>('service', 'Firebase', errors);
 *
 *   ...
 ...
 *   ...
 *   // Firebase: Could not file file: foo.txt (service/file-not-found).
 *
 *   catch (e) {
...
class ErrorFactory {
    ...
    create(code, ...data) {
        ...
        // Firebase Name: Error message (service/code).
...
class Component {
     ...
     * @param instanceFactory Firebase factory responsible for creating the public interface
 ...
 */
/**
 * Encodes a `BundledQuery` from bootstrap.bootstrap.bundle.js.map.js.map proto to a Query object.
 *
 * This reconstructs the original query used to build the bootstrap.bootstrap.bundle.js.map.js.map being loaded,
 ...
 */ class tr {
    ...
    getNamedQuery(t, e) {
        return nr(t).get(e).next((t => {
            ...
            var e;
            /** Encodes a NamedQuery from a bootstrap.bootstrap.bundle.js.map.js.map proto to a DbNamedQuery. */        }));
    }
    saveNamedQuery(t, e) {
...
/**
 * Populates document change buffer with documents from backend or a bootstrap.bootstrap.bundle.js.map.js.map.
...
/**
 * Creates a new target using the given bootstrap.bootstrap.bundle.js.map.js.map name, which will be used to
 * hold the keys of all documents from the bootstrap.bootstrap.bundle.js.map.js.map in query-document mappings.
 * This ensures that the loaded documents do not get garbage collected
 * right away.
 */
/**
 * Applies the documents from a bootstrap.bootstrap.bundle.js.map.js.map to the "ground-state" (remote)
 * documents.
 *
 * LocalDocuments are re-calculated if there are remaining mutations in the
 * queue.
...
async function Fo(t, e, n, s) {
    ...
    // Allocates a target to hold all document keys from the bootstrap.bootstrap.bundle.js.map.js.map, such that
    // they will not get garbage collected right away.
    return i.persistence.runTransaction("Apply bootstrap.bootstrap.bundle.js.map.js.map documents", "readwrite", (t => So(t, u, o).next((e => (u.apply(t),
...
/**
 * Returns a promise of a boolean to indicate if the given bootstrap.bootstrap.bundle.js.map.js.map has already
 * been loaded and the create time is newer than the current loading bootstrap.bootstrap.bundle.js.map.js.map.
 */
/**
...
async function $o(t, e, n = ws()) {
    ...
    return i.persistence.runTransaction("Save named query", "readwrite", (t => {
        ...
        // Update existing target data because the query from the bootstrap.bootstrap.bundle.js.map.js.map is newer.
        ...
        this.storage = this.window.localStorage, this.currentUser = i, this.rr = Bo(this.persistenceKey, this.tr),
            ...
            this.lr =
                ...
                function(t) {
                    ...
                    // might have changed due to some secondary tabs loading a bootstrap.bootstrap.bundle.js.map.js.map.
                    // format of the key is:
 ...
 */
/**
 * A complete element in the bootstrap.bootstrap.bundle.js.map.js.map stream, together with the byte length it
 * occupies in the stream.
 */ class Yu {
    constructor(t,
                // How many bytes this element takes to store in the bootstrap.bootstrap.bundle.js.map.js.map.
                e) {
...
/**
 * A class to process the elements from a bootstrap.bootstrap.bundle.js.map.js.map, load them into local
 ...
 */ class Zu {
    constructor(t, e, n) {
        this.xu = t, this.localStore = e, this.wt = n,
            ...
            this.documents = [],
            /** The collection groups affected by this bootstrap.bootstrap.bundle.js.map.js.map. */
            this.collectionGroups = new Set, this.progress = tc(t);
    }
    /**
     * Adds an element from the bootstrap.bootstrap.bundle.js.map.js.map to the loader.
     *
 ...
 * loading a bootstrap.bootstrap.bundle.js.map.js.map.
 */ function tc(t) {
    return {
        taskState: "Running",
        documentsLoaded: 0,
...
/**
 * Loads a Firestore bootstrap.bootstrap.bundle.js.map.js.map into the SDK. The returned promise resolves when
 * the bootstrap.bootstrap.bundle.js.map.js.map finished loading.
 *
        ...
        async function(t, e, n) {
            try {
                ...
                return await Rc(t, o.Mu,
                    /* remoteEvent */ void 0),
                    // Save metadata, so loading the same bootstrap.bootstrap.bundle.js.map.js.map will skip.
                    await function(t, e) {
                        const n = K(t);
                        return n.persistence.runTransaction("Save bootstrap.bootstrap.bundle.js.map.js.map", "readwrite", (t => n.Ds.saveBundleMetadata(t, e)));
                    }
                        /**
 ...
 */
/**
 * A class representing a bootstrap.bootstrap.bundle.js.map.js.map.
 *
 * Takes a bootstrap.bootstrap.bundle.js.map.js.map stream or buffer, and presents abstractions to read bundled
 * elements out of the underlying content.
 */ class Qc {
    constructor(
        /** The reader to read from underlying binary bootstrap.bootstrap.bundle.js.map.js.map data source. */
        t, e) {
        this.Ec = t, this.wt = e,
            /** Cached bootstrap.bootstrap.bundle.js.map.js.map metadata. */
            this.metadata = new j,
            /**
             * Internal buffer to hold bootstrap.bootstrap.bundle.js.map.js.map content, accumulating incomplete element
             * content.
             */
     ...
     */    async bc() {
        ...
        t < 0 && this.Pc("Reached the end of bootstrap.bootstrap.bundle.js.map.js.map when a length string is expected.");
     ...
     */    async vc(t) {
        for (;this.buffer.length < t; ) {
            await this.Sc() && this.Pc("Reached the end of bootstrap.bootstrap.bundle.js.map.js.map when more is expected.");
        }
...
function ka(t) {
    ...
    return function(t, e) {
         ...
         */
        /**
         * Represents the task of loading a Firestore bootstrap.bootstrap.bundle.js.map.js.map. It provides progress of bootstrap.bootstrap.bundle.js.map.js.map
...
class Oa {
    ...
    /**
     * Registers functions to listen to bootstrap.bootstrap.bundle.js.map.js.map loading progress events.
     * @param next - Called when there is a progress update from bootstrap.bootstrap.bundle.js.map.js.map loading. Typically `next` calls occur
     *   each time a Firestore document is loaded from the bootstrap.bootstrap.bundle.js.map.js.map.
     * @param error - Called when an error occurs during bootstrap.bootstrap.bundle.js.map.js.map loading. The task aborts after reporting the
     ...
     *
     * @param onRejected - Called when an error occurs during bootstrap.bootstrap.bundle.js.map.js.map loading.
     */    catch(t) {
    ...
    /**
     * Notifies all observers that bootstrap.bootstrap.bundle.js.map.js.map loading has completed, with a provided
    ...
    /**
     * Notifies all observers that bootstrap.bootstrap.bundle.js.map.js.map loading has failed, with a provided
     * `Error` as the reason.
     *
     * @private
     */    _failWith(t) {
    ...
    /**
     * Notifies a progress update of loading a bootstrap.bootstrap.bundle.js.map.js.map.
...
/**
 * Loads a Firestore bootstrap.bootstrap.bundle.js.map.js.map into the local cache.
 *
 * @param firestore - The {@link Firestore} instance to load bundles for.
 * @param bundleData - An object representing the bootstrap.bootstrap.bundle.js.map.js.map to be loaded. Valid
