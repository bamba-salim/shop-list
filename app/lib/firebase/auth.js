...
function _debugErrorMap() {
    return {
        ...
        'Android package name or iOS bootstrap.bootstrap.bundle.js.map.js.map ID) provided is not installed on ' +
        'this device.',
 ...
 * bootstrap.bootstrap.bundle.js.map.js.map size.
 *
 * @public
 */
const AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = {
    ...
    MISSING_IOS_BUNDLE_ID: 'auth/missing-ios-bootstrap.bootstrap.bundle.js.map.js.map-id',
 ...
 * need control over which persistence layer is used, or to minimize bootstrap.bootstrap.bundle.js.map.js.map
